<script setup lang="ts">
    ...
    import AddProductModal from '@/components/backend/AddProductModal.vue'
    ...
    // -----------------------------
    // ฟังก์ชันสำหรับเรียกเปิดแสดงผล Modal
...
<template>
    ...
    <div class="flex items-center justify-between my-8">
        ...
        <button @click="openModal" class="flex items-center justify-between px-4 py-2 mx-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-500 border border-transparent rounded-lg active:bg-purple-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-purple">
    ...
    <!-- Pagination Controls -->
    <div class="grid px-4 py-3 mb-2 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
    ...
    <AddProductModal :show="showModal" />
